      ...
      <div className={`${tk.navBg} rounded-2xl shadow-2xl max-w-md w-full p-7 border ${tk.border}`}>
        ...
        <div className="flex gap-3">
          ...
          <button
            ...
            className="flex-1 px-4 py-2.5 bg-[#E8192C] text-white rounded-full hover:bg-[#FF1F30] font-black text-xs uppercase tracking-widest transition-all disabled:opacity-30 disabled:cursor-not-allowed shadow-lg shadow-[#E8192C]/20"
          >
            Save & Add
          </button>
        </div>
          ...
          <div className={`flex flex-col sm:flex-row justify-between gap-3 mt-8 pt-7 border-t ${tk.border}`}>
            ...
            {currentStep < 3 ? (
              <button
                ...
                className="flex items-center justify-center gap-2 px-6 py-2.5 rounded-full bg-[#E8192C] text-white font-black text-xs uppercase tracking-widest hover:bg-[#FF1F30] transition-all duration-150 shadow-lg shadow-[#E8192C]/20 disabled:opacity-30 disabled:cursor-not-allowed disabled:shadow-none"
              >
              ...
              <div className="flex gap-3 w-full sm:w-auto">
                ...
                <button onClick={saveManifest} disabled={isLoading}
                  className={`flex-1 sm:flex-none flex items-center justify-center gap-2 px-6 py-2.5 rounded-full font-black text-xs uppercase tracking-widest transition-all duration-150 shadow-lg disabled:opacity-30 disabled:cursor-not-allowed ${
                    isEditMode
