  ...
  return (
    <div className="min-h-screen bg-black relative overflow-hidden flex items-center justify-center">
      ...
      <div className="absolute top-8 left-8 z-20 flex items-center gap-3">
        ...
        <span className="text-[10px] uppercase tracking-[0.25em] font-bold text-[#9A9A9A]">Warehouse</span>
      </div>
      ...
      <div className="relative z-10 w-full max-w-[480px] px-6">
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <div className="space-y-2">
            <label htmlFor="email" className="block text-[10px] uppercase tracking-[0.2em] font-bold text-[#9A9A9A]">
              Email
            </label>
            <input
              id="email"
          ...
          {/* Password */}
          <div className="space-y-2">
            <label htmlFor="password" className="block text-[10px] uppercase tracking-[0.2em] font-bold text-[#9A9A9A]">
              Password
            </label>
            <div className="relative">
              ...
              <button
                ...
                className="absolute right-3.5 top-1/2 -translate-y-1/2 text-[#9A9A9A] hover:text-[#9A9A9A] transition-colors"
              >
                {showPassword
